...
export function SkillCard({ skill }: { skill: Skill }) {
  ...
  return (
    <div className="group relative glass-card p-5 sm:p-6 rounded-2xl border border-black/10 dark:border-white/10 hover:border-[#F4512A]/60 dark:hover:border-[#F4512A]/60 transition-all duration-300 hover:shadow-xl bg-white/60 dark:bg-zinc-900/60 flex flex-col justify-between">
      <div>
